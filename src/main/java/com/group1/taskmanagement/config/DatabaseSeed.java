...
public class DatabaseSeed implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        String task1Sql = "INSERT INTO tasks (title, description, user_id, status, created_date, due_date, difficulty) " +
                "SELECT 'Task 1', 'Description of Task 1', app_users.user_id, 'TO_DO', CURRENT_TIMESTAMP, CURRENT_DATE + 7, 'HARD' " +
                "FROM app_users " +
        ...
        String task2Sql = "INSERT INTO tasks (title, description, user_id, status, created_date, due_date, difficulty) " +
                "SELECT 'Task 2', 'Description of Task 2', app_users.user_id, 'IN_PROGRESS', CURRENT_TIMESTAMP, CURRENT_DATE + 7, 'EASY' " +
                "FROM app_users " +
